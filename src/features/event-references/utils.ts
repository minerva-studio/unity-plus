...
import type { RunWithConcurrencyOptions } from './runtime';
...
/** Represents an expected cancellation rather than a failed UnityEvent scan. */
export class UnityEventReferenceScanCanceledError extends Error {
  constructor() {
